...
export type Mutation = {
  ...
  /**
   * Set the Claude model for an agent session. Takes effect on the next process spawn.
   * Use short names like "sonnet", "opus", "haiku". Empty string clears the override (uses CLI default).
   */
  setAgentModel: Scalars['Boolean']['output'];
  /**
...
export type MutationSetAgentModelArgs = {
  beanId: Scalars['ID']['input'];
...
export type SetAgentModelMutationVariables = Exact<{
  beanId: Scalars['ID']['input'];
  model: Scalars['String']['input'];
}>;


export type SetAgentModelMutation = { setAgentModel: boolean };
...
export const SetAgentModelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetAgentModel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"beanId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"model"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setAgentModel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"beanId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"beanId"}}},{"kind":"Argument","name":{"kind":"Name","value":"model"},"value":{"kind":"Variable","name":{"kind":"Name","value":"model"}}}]}]}}]} as unknown as DocumentNode<SetAgentModelMutation, SetAgentModelMutationVariables>;
